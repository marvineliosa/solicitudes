...
class RelObservacinesGeneralesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('REL_OBSERVACIONES_GENERALES', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('REL_OBSERVACIONES_GENERALES');
    }
}
